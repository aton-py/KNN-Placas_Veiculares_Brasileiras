...
def main():
    ...
    if blnKNNTrainingSuccessful == False:
        ...
        # e fechar programa
    # end if
    #C:\Users\Laptop\Desktop\teste_placa
    imgCenaOriginal = cv2.imread("C:\\Users\\Laptop\\Desktop\\EngComp\\Período7\\IA\\OpenCV_LPR\\PlacasSelecionadas\\ABC-1234.png")
    #imgCenaOriginal = cv2.resize(img,None,fx=1.0, fy=1.0, interpolation = cv2.INTER_CUBIC)
